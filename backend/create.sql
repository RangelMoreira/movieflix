create table tb_genere (id int8 generated by default as identity, name varchar(255), primary key (id));
create table tb_movie (id int8 generated by default as identity, img_url varchar(255), sub_title varchar(255), synopsis varchar(255), title varchar(255), year int4, genere_id int8, primary key (id));
...
alter table if exists tb_movie add constraint FKi9u8qd5mxxtd5fj7adc7fjt0j foreign key (genere_id) references tb_genere;
